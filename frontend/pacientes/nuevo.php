...
<head>
    ...
    <title>EPS UNIVERSAL | Nuevos pacientes</title>
</head>
<body>
...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off" onsubmit="return validacion()">
  ...
  <strong>Importante!</strong> Es importante rellenar los campos con &nbsp;<span class="badge-warning">*</span>
    ...
    <label for="email"><b>identificacion del paciente</b></label><span class="badge-warning">*</span>
    ...
    <input type="text" placeholder="ejm: miguel " name="namp" required>
    ...
    <input type="text" placeholder="" name="dip" required>
    ...
    <input type="text" maxlength="10" placeholder="ejm: 999 888 7111" name="telp" required>
