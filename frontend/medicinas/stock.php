...
<head>
    ...
    <title>Clínica Salud | Stock de las medicinas</title>
</head>
<body>
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li><a href="mostrar.php">Listado de las medicinas</a></li>
                 <li class="divider">></li>
                <li><a href="#" class="active">Stock de las medicinas</a></li>
            </ul>
         <?php 
...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off" onsubmit="return validacion()">
  ...
  <strong>Importante!</strong> Es importante rellenar los campos con &nbsp;<span class="badge-warning">*</span>
    ...
    <input type="text" maxlength="2" value="<?php echo $d->stock; ?>"  placeholder="ejm:  3"  name="medistoc" required>
