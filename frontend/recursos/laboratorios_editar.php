...
<head>
    ...
    <title>EPS UNIVERSAL | Actualizar del laboratorio</title>
</head>
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="laboratiorios.php">Listado de las unidades</a></li>
                 <li class="divider">></li>
                <li><a href="#" class="active">Actualizar de la unidad</a></li>
            </ul>
...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off" onsubmit="return validacion()">
  <div class="containerss">
    <h1>Información de la unidades</h1>
