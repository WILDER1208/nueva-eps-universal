...
<head>
    ...
    <title>EPS UNIVERSAL | Nuevo médico</title>
</head>
<body>
...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off" onsubmit="return validacion()">
  ...
  <strong>Importante!</strong> Es importante rellenar los campos con &nbsp;<span class="badge-warning">*</span>
    ...
    <input type="text" placeholder="ejm: 1019741478" name="cem" maxlength="10" required>
    ...
    <input type="text" maxlength="10" placeholder="ejm: 999 888 1111" name="telme" required>
